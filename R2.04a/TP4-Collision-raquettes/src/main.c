...
extern u32 is_intersecting_paddle(s16 ball_x, s16 ball_y, s16 paddle_x, s16 paddle_y);
u32 is_intersecting_paddle(s16 ball_x, s16 ball_y, s16 paddle_x, s16 paddle_y) {
...
u32 collision_or_lost(s16 ball_x, s16 ball_y, s16 paddle_x, s16 paddle_y, s16 * ptr_dir_y);
...
static void breakout(void) {
	...
	while(1) {
		...
		game_over = collision_or_lost(ball_x, ball_y, paddle_x, paddle_y, &dir_y);
