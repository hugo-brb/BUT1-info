...
public class Ile implements Comparable<Ile>{
    ...
    public int compareTo(Ile o) {
        ...
        if (this.getPays().get(0).compareTo(o.getPays().get(0)) < 0
        || (this.getPays().get(0).equals(o.getPays().get(0)) && (this.getSuperficie() < o.getSuperficie()))){
            return -1;
        }else if (this.getPays().get(0).equals(o.getPays().get(0)) && this.getSuperficie() == o.getSuperficie()){
            return 0;
        }else {
            return 1;
        }
